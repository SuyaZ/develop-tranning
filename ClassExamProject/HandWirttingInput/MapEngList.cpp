...
MapEngList::MapEngList(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
	...
	engplay = new QGridLayout(this); //父布局是this
	...
	for (int i = 0; i < buttonTexts.size(); i++)
	{
		...
		engplay->addWidget(btn, i / 9, i % 9, 1, 1);
	}
	...
	//子窗口和父窗口链接 
	QObject::connect(this, SIGNAL(doclicked(const QString&)), this->parent(), SLOT(inputEngButton(QString)));

	//布置布局
	this->setLayout(engplay);


}

MapEngList::~MapEngList()
{
	delete engplay;
	delete signalMapper;
}
