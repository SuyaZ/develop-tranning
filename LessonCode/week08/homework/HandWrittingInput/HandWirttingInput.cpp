    ...
    : QMainWindow(parent)
{
    ...
    //设置按钮的颜色 默认的颜色，不强制设置的话不同的机器显示的效果会不一样
    Sugbtn1->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    Sugbtn2->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    Sugbtn3->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    Sugbtn4->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    ...
    eraseBtn->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    rewriteBtn->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    ...
    btn1->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    btn2->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    btn3->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    btn4->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
    btn5->setStyleSheet("QPushButton { background-color: rgb(255, 255, 255)}");
